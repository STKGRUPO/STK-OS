...
type FiscalDocument = { id: string; document_type: string; content_type: string; status: string; download_path: string | null };
type Issuance = {
  id: string;
...
export default function BillingWorkspace({
  ...
  async function downloadDocument(document: FiscalDocument) {
    ...
    try {
      ...
      anchor.href = url; anchor.download = `${document.document_type}.${document.content_type.includes("xml") ? "xml" : "pdf"}`; anchor.click();
